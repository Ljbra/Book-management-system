...
<html class="x-admin-sm">
	...
	<c:set var="id" value="${manage != null ? manage.id : param.id }"></c:set>
    <c:set var="oldaccount" value="${manage != null ? manage.account : param.oldaccount }"></c:set>
    <c:set var="account" value="${manage != null ? manage.account : param.oldaccount }"></c:set>
    <c:set var="pw" value="${manage != null ? manage.pw : param.pw }"></c:set>   
       
        <div class="layui-fluid">
            <div class="layui-row">
                <form class="layui-form" action="update.does" method = "post">
